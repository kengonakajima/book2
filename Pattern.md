...
- 通信量: コントローラーの情報を毎フレーム送る。(タイムスタンプ32、ビット列32)合計8バイトを互いにUDPで送る。8x60=480バイト/s。UDPヘッダ(+40)入れると48x60=2880B/sec。　これで十分に軽いので、通信量を削減する必要はない。
...
- チート: チートを厳密に防ぎたいときはBで完全同期。そうでないときはC。
